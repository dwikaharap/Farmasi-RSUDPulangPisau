                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body table-responsive">
                                    <table id="table_ok" class="table table-bordered table-striped bolder helv">
                                        <thead>
                                            <tr style="background-color:green">
                                                <th style="color: mintcream;">Kode Obat</th>
                                                <th style="color: mintcream;">Nama Obat</th>
                                                <th style="color: mintcream;">Bulan</th>
                                                <th style="color: mintcream;">Tahun</th>
                                                <th style="color: mintcream;">Total</th>
...
<?php $this->load->view("templates/js_obatkeluar.php") ?>
