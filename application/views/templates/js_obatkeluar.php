...
<script src="<?php echo base_url('assets/dist') ?>/yadcf/jquery.dataTables.yadcf.js"></script>
<!-- page script -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table_ok = $('#table_ok').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('obat/ajax_list_obatkeluar') ?>",
                "type": "POST"
            },
